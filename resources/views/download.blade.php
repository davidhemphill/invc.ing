<x-layout>
    <div x-data class="mx-auto bg-white dark:bg-gray-950 rounded-lg max-w-sm p-8 flex flex-col gap-6">
        ...
        <div>
            <button x-on:click="$clipboard('{{ route("invoices.show", $invoice) }}')" type="button"
                    class="button button-copy gap-2">
                <svg class="w-4 h-4 -mt-[1px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
